...
main_df = pd.read_csv(
    'C:/Users/nss_1/Pictures/Automated_BSA_pipeline/Test_dataset.csv', sep=';', low_memory=False)
# Example usage
if __name__ == "__main__":
 ...
 #   main_df["Date"] = pd.to_datetime(main_df["Date"])
    ...
    for ticker in ticker_list:
        ...
        sub_df["Date"] = pd.to_datetime(pd.to_datetime(main_df["Date"], errors='coerce')  # safely convert
        ...
        main_df.loc[merged.index, merged.columns.difference(
            sub_df.columns)] = merged[merged.columns.difference(sub_df.columns)]
