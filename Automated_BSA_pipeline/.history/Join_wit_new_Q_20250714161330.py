...
print("Unique dates in 'date_y':", df['date_y'].unique())

# Debug: show count of rows to be cleared
mask = df['date_y'] == '2025-03-31'
print("Rows to clear:", df[mask].shape[0])

# Apply the clearing if any row matches
if mask.any():
    df.loc[mask, columns_to_clear] = np.nan
    print("Values cleared for 2025-03-31")
else:
    print("No matching rows found")

# Save the result
output_path = 'C:/Users/nss_1/Pictures/Automated_BSA_pipeline/Test_dataset.csv'
