...
#        Step 1: Drop overlapping columns from fin_wide before merging
        overlapping_cols = [
            col for col in fin_wide.columns if col in sub_df.columns and col != "Date"]
        fin_wide = fin_wide.drop(columns=overlapping_cols)
    ...
    output_path = "C:/Users/nss_1/Pictures/Automated_BSA_pipeline/final_features_output_updated.csv"
