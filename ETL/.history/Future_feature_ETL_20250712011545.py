...
# ----------------- Main -----------------
INPUT_FILE = "D:/ETLstock_with_fundamentals.csv"
...
if __name__ == "__main__":
    ...
    # Step 2: Chunked processing and save intermediate file
    reader = pd.read_csv(
        INPUT_FILE,
        sep=';',
        parse_dates=['date_x'],
    ...
    # Step 3: Load all processed chunks
    base_df = pd.read_parquet(OUTPUT_PARQUET)
