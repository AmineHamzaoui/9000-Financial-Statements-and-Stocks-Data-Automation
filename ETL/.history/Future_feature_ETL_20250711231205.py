...
def detect_smc_patterns(df, swing_length=5):
    ...
    for ticker, group in df.groupby("Ticker"):
        ...
        # Add back results to the original group DataFrame
    ...
    # Concatenate all processed tickers
