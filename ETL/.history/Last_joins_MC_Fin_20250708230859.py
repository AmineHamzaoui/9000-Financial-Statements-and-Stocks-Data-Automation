...
merged_df.sort_values(['Ticker', 'Date'], ascending=[True, True], inplace=True)
merged_df.reset_index(drop=True, inplace=True)

financial_data.sort_values(['Ticker', 'date'], ascending=[True, True], inplace=True)
financial_data.reset_index(drop=True, inplace=True)

# ✅ Debug check — uncomment to inspect sorted columns
# print(merged_df[['Ticker', 'Date']].head(10))
# print(financial_data[['Ticker', 'date']].head(10))
