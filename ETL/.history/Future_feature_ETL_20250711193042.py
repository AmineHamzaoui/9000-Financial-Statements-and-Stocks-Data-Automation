...
if __name__ == "__main__":
    ...
    final_df['Performance'] = final_df.groupby('Ticker')['Close'].pct_change(periods=252) * 100
    final_df['Performance'] = final_df.groupby('Ticker')['Close'].pct_change(periods=756) * 100
    final_df['Performance'] = final_df.groupby('Ticker')['Close'].pct_change(periods=1260) * 100
