...
if __name__ == "__main__":
    ...
    final_df['Performance 3Y'] = final_df.groupby('Ticker')['Close'].pct_change(periods=756) * 100
    final_df['Performance 5Y Return'] = final_df.groupby('Ticker')['Close'].pct_change(periods=1260) * 100
