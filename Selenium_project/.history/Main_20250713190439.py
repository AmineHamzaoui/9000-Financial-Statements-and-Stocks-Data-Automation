...
scraping_scripts = [
    ...
    ("Yahoo_Finance_Data.py", "📥 Combine Yahoo Finance Historical"),
    ("Sectors_industry.py", "🏷️ Extract Sector & Industry Data")
]
